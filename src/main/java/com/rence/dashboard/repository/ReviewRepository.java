...
public interface ReviewRepository extends JpaRepository<ReviewListVO, Object>{
	...
	@Query(nativeQuery = true, value = "select review_no, review_content, review_point, TO_CHAR(review_date, 'YYYY-MM-DD HH24:MI:SS') as review_date, user_image, substr(user_name,1,1)||lpad('*',length(user_name)-2,'*') \r\n"
			+ "		from(\r\n"
	...
	List<ReviewListVO> backoffice_review_selectAll(String backoffice_no);
