...
import com.rence.dashboard.model.ReserveEntity;
import com.rence.dashboard.model.ReserveSummaryVO;


public interface ReserveRepository extends JpaRepository<ReserveEntity, Object> {
	...
	List<ReserveSummaryVO> selectAll_reserve_summary(String backoffice_no);
