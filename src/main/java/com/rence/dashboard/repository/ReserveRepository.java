...
public interface ReserveRepository extends JpaRepository<ReserveVO, Object> {
	...
	public List<ReserveVO> backoffice_reserve_selectAll(String backoffice_no, Integer start_row, Integer end_row);
	...
	public List<ReserveVO> backoffice_reserve_selectAll_inuse(String backoffice_no, Integer start_row, Integer end_row);
	...
	public List<ReserveVO> backoffice_reserve_selectAll_end(String backoffice_no, Integer start_row, Integer end_row);
	...
	public List<ReserveVO> backoffice_reserve_selectAll_cancel(String backoffice_no, Integer start_row, Integer end_row);
