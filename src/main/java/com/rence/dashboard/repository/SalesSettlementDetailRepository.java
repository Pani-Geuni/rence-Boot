...
public interface SalesSettlementDetailRepository extends JpaRepository<SalesSettlementDetailView, Object> {
	...
	@Query(nativeQuery = true, value = "select NVL(sum(payment_total),0) as sales_cancel from paymentinfo p left outer join reserveinfo rv on p.reserve_no=rv.reserve_no where payment_state='T' and (current_date-payment_date)*24<=1 and rv.backoffice_no=?1  and rv.reserve_state='cancel' and trunc(payment_date)=trunc(current_date)-1")
	...
	@Query(nativeQuery = true, value = "select NVL(sum(payment_total*0.8),0) from paymentinfo p left outer join reserveinfo rv on p.reserve_no=rv.reserve_no where payment_state='T' and ((current_date-payment_date)*24>1) and rv.backoffice_no=?1 and rv.reserve_state='cancel' and trunc(payment_date)=trunc(current_date)-1")
	...
	@Query(nativeQuery = true, value = "select NVL(sum(payment_total),0) as sales_cancel from paymentinfo p left outer join reserveinfo rv on p.reserve_no=rv.reserve_no where payment_state='T' and (current_date-payment_date)*24<=1 and rv.backoffice_no=?1  and rv.reserve_state='cancel' and trunc(payment_date) between trunc(current_date) - interval '7' day and trunc(current_date) ")
	...
	@Query(nativeQuery = true, value = "select NVL(sum(payment_total*0.8),0) from paymentinfo p left outer join reserveinfo rv on p.reserve_no=rv.reserve_no where payment_state='T' and ((current_date-payment_date)*24>1) and rv.backoffice_no=?1 and rv.reserve_state='cancel' and trunc(payment_date) between trunc(current_date) - interval '7' day and trunc(current_date) ")
	...
	@Query(nativeQuery = true, value = "select NVL(sum(payment_total),0) as sales_cancel from paymentinfo p left outer join reserveinfo rv on p.reserve_no=rv.reserve_no where payment_state='T' and (current_date-payment_date)*24<=1 and rv.backoffice_no=?1  and rv.reserve_state='cancel' and trunc(payment_date) between trunc(current_date) - interval '14' day and trunc(current_date) - interval '7' day")
	...
	@Query(nativeQuery = true, value = "select NVL(sum(payment_total),0) as sales_cancel from paymentinfo p left outer join reserveinfo rv on p.reserve_no=rv.reserve_no where payment_state='T' and (current_date-payment_date)*24<=1 and rv.backoffice_no=?1  and rv.reserve_state='cancel' and trunc(payment_date) between add_months(trunc(current_date),-1) and trunc(current_date)")
	...
	@Query(nativeQuery = true, value = "select NVL(sum(payment_total),0) as sales_cancel from paymentinfo p left outer join reserveinfo rv on p.reserve_no=rv.reserve_no where payment_state='T' and (current_date-payment_date)*24<=1 and rv.backoffice_no=?1  and rv.reserve_state='cancel' and trunc(payment_date) between add_months(trunc(current_date),-2) and add_months(trunc(current_date),-1)")
