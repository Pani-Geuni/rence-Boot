...
//		return b_repository.backoffice_select_pw(bvo.getBackoffice_no(),bvo.getBackoffice_pw());
	...
	public List<SalesSettlementViewVO> backoffice_sales_selectAll(String backoffice_no, Integer page) {
		...
		log.info("start_row: " + start_row);
		log.info("end_row: " + end_row);
		return s_repository.backoffice_sales_selectAll(backoffice_no,start_row, end_row);
	}
	...
	public int backoffice_updateOK_opt(BackOfficeOperatingTimeVO_datetype ovo2) {
		...
		return o_repository.backoffice_updateOK_opt(ovo2, ovo2.getMon_stime(), ovo2.getMon_etime(), ovo2.getTue_stime(),
				ovo2.getTue_etime(), ovo2.getWed_stime(), ovo2.getWed_etime(), ovo2.getThu_stime(), ovo2.getThu_etime(),
				ovo2.getFri_stime(), ovo2.getFri_etime(), ovo2.getSat_stime(), ovo2.getSat_etime(), ovo2.getSun_stime(),
				ovo2.getSun_etime());
	}
