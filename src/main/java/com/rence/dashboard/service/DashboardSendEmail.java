...
public class DashboardSendEmail {
	...
	public int reserve_cancel_mail(String user_no, String user_email, String reserve_stime, String reserve_etime, String company_name) {
		...
		try {
			...
			msg.setText("안녕하세요."+ company_name +"입니다."+"<br><br>"+reserve_stime+"~"+reserve_etime+"<br><br>"+"예정된 예약이 내부 사정으로 인해 불가피하게 취소 됨을 알려드립니다."+"<br><br>"+"빠른 시일 내로 환불 처리를 진행해 드리겠습니다."+"<br><br>"+"불편을 드려 대단히 죄송합니다.");
