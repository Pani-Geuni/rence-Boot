...
public interface OfficeReserveRepository extends JpaRepository<OfficeReserveVO, Object> {
	...
	@Query(nativeQuery = true, 
			value = "select reserve_no, TO_CHAR(reserve_stime, 'HH24') reserve_stime, TO_CHAR(reserve_etime, 'HH24') reserve_etime, TO_CHAR(reserve_sdate, 'HH24') reserve_sdate, TO_CHAR(reserve_edate, 'HH24') reserve_edate, reserve_state, room_no, user_no, backoffice_no, room_type "
					+ "from reserveinfo "
