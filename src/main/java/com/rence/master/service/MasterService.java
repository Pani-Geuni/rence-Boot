...
public class MasterService {
	...
	public List<BackOfficeVO> backoffice_applyList_selectAll(Integer currentPage) {
		...
		return b_repository.selectAll_backoffice_apply(start_row, end_row);
	}
	 ...
	 * 
	 */
	public List<BackOfficeVO> backoffice_endList_selectAll(Integer page) {
		log.info("backoffice_applyList_selectAll().....");
		...
		return b_repository.selectAll_backoffice_end(start_row, end_row);
	}
